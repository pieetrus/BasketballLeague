...
namespace BasketballLeague.Persistence.Migrations
{
    ...
    [Migration("20200925103848_AddStartedBolleanAndJerseyColorColumnsToMatchTable")]
    partial class AddStartedBolleanAndJerseyColorColumnsToMatchTable
    {
            ...
            modelBuilder.Entity("BasketballLeague.Domain.Entities.Match", b =>
                {
                    ...
                    b.Property<string>("TeamGuestJerseyColor")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TeamHomeJerseyColor")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("TeamSeasonGuestId");

                    b.HasIndex("TeamSeasonHomeId");
            ...
            modelBuilder.Entity("BasketballLeague.Domain.Entities.PlayerMatch", b =>
                {
                    ...
                    b.HasIndex("PlayerSeasonId", "MatchId")
                        .IsUnique()
            ...
            modelBuilder.Entity("BasketballLeague.Domain.Entities.Rebound", b =>
                {
                    ...
                    b.HasIndex("FreeThrowId")
                        .IsUnique()
                        .HasFilter("[FreeThrowId] IS NOT NULL");

                    b.HasIndex("PlayerId");

                    b.HasIndex("ShotId")
                        .IsUnique()
                        .HasFilter("[ShotId] IS NOT NULL");
            ...
            modelBuilder.Entity("BasketballLeague.Domain.Entities.TeamMatch", b =>
                {
                    ...
                    b.Property<int>("Fouls1Qtr")
                        .HasColumnType("int");

                    b.Property<int>("Fouls2Qtr")
                        .HasColumnType("int");

                    b.Property<int>("Fouls3Qtr")
                        .HasColumnType("int");

                    b.Property<int>("Fouls4Qtr")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Timeouts1Half")
                        .HasColumnType("int");

                    b.Property<int>("Timeouts2Half")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BasketballLeague.Domain.Entities.PlayerMatch", b =>
                {
                    ...
                    b.HasOne("BasketballLeague.Domain.Entities.PlayerSeason", "PlayerSeason")
                        .WithMany("PlayerMatches")
